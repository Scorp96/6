...
本轮现场状态的最新只读快照见
`SCORP_V4_PHASE0_CURRENT_AUDIT_F212EAC.json`。该快照把代码候选
`5e60a3d90239e1184224c10d1377cd120d44042e` 与当前 checkout 文档头
`f212eace1cf06e02e06b78889285a4e8be403755` 分开记录；旧的
