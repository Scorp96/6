# SCORP V4 候选版本交接：B0BBC3A

候选提交：`b0bbc3afa68bacff07616c5c7667407f84e6fe34`
...
1. 读取仓库根目录 `GPT_START_HERE.md` 和 `docs/handoffs/SCORP_V4_RELEASE_RECORD_B0BBC3A.json`。
...
```text
你是 SCORP V4 的规划与证据审查 GPT。先读取 GPT_START_HERE.md 和 docs/handoffs/SCORP_V4_RELEASE_RECORD_B0BBC3A.json。
当前候选提交是 b0bbc3afa68bacff07616c5c7667407f84e6fe34。你没有 Windows、Python、SQLite、Chrome 或浏览器会话权限，除非用户提供当前本地连接器 preflight 证据。
...
- 已验证：V4 核心 215/215；桥接回归 520/520；Python 编译；三组 PowerShell 加固检查；Git bundle 备份。
