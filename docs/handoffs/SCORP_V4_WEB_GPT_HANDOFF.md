...
当前候选版本是 GPT-5.6 Sol 兼容路径，代码候选提交为 `5e60a3d90239e1184224c10d1377cd120d44042e`。该身份与 `docs/handoffs/SCORP_V4_FAST_RUNTIME_COMMAND_CORE_VALIDATION.json`、`SCORP_V4_FAST_RUNTIME_CANDIDATE_MANIFEST_5E60A3D.json` 和 `SCORP_V4_FAST_RUNTIME_PREFLIGHT_424FFE3.json` 一致。交接文件定义的是连接边界和使用顺序，不把规划文档当成运行证据。
