...
当前候选版本是 GPT-5.6 Sol 兼容路径，代码候选提交为 `b8e5cbd9659a4b75d4db9169ea2865c22fff902b`。该身份与 `docs/handoffs/SCORP_V4_FAST_RUNTIME_COMMAND_CORE_VALIDATION.json`、`SCORP_V4_FAST_RUNTIME_CANDIDATE_MANIFEST_B8E5CBD.json` 和 `SCORP_V4_FAST_RUNTIME_PREFLIGHT_B8E5CBD.json` 一致。交接文件定义的是连接边界和使用顺序，不把规划文档当成运行证据。
