...
当前候选版本是 GPT-5.6 Sol 兼容路径，代码候选提交为 `6265f49e04ce9bd47d25e4a2a3609bf3878b9fc9`。该身份与 `docs/handoffs/SCORP_V4_FAST_RUNTIME_COMMAND_CORE_VALIDATION.json`、`SCORP_V4_FAST_RUNTIME_CANDIDATE_MANIFEST_6265F49.json` 和 `SCORP_V4_LIVE_READONLY_PREFLIGHT_28B0F28.json` 一致。交接文件定义的是连接边界和使用顺序，不把规划文档当成运行证据。
