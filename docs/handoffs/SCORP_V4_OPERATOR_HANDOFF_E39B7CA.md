# SCORP V4 候选版本交接：E39B7CA

候选提交：`e39b7caf0006a02424a1705c35c448ada9e612c3`
...
1. 读取仓库根目录 `GPT_START_HERE.md` 和 `docs/handoffs/SCORP_V4_RELEASE_RECORD_E39B7CA.json`。
...
```text
你是 SCORP V4 的规划与证据审查 GPT。先读取 GPT_START_HERE.md 和 docs/handoffs/SCORP_V4_RELEASE_RECORD_E39B7CA.json。
当前候选提交是 e39b7caf0006a02424a1705c35c448ada9e612c3。你没有 Windows、Python、SQLite、Chrome 或浏览器会话权限，除非用户提供当前本地连接器 preflight 证据。
...
- 已验证：V4 核心 213/213；桥接回归 518/518；Python 编译；三组 PowerShell 加固检查；Git bundle 备份。
