...
- Current candidate: `ee64ca4d943cdc4cdd761c11d7f4f74e881c7e81`
...
`SCORP_V4_GIT6_CANDIDATE_MANIFEST_ee64ca4.json`,
`SCORP_V4_GIT6_AC10_AC12_EVIDENCE_ee64ca4.json`, and
`SCORP_V4_GIT6_AC12_SHORT_SOAK_ee64ca4.json`. The installed monitor probe is
recorded in `SCORP_V4_GIT6_SUPERVISOR_RUNTIME_ee64ca4.json`. AC10 covers a
38-file detached
candidate install with unchanged protected-root hashes. AC12 covers a 10.20 s
run with 48 cycles, two Worker slots, slot reuse, two scheduler recoveries, and
...
`SCORP_V4_GIT6_PREFLIGHT_ee64ca4.json`. The preflight reports
