...
async def main():
    ...
    if "use_dom=True requires use_ui_tree=True" in dom:
        raise RuntimeError("DOM_SNAPSHOT_PARAMETER_REJECTED")
    summary = {
        "turn_id": turn_id,
    ...
    print("LIVE_MASTER_VALID_DOM_COMPARE=" + json.dumps(summary, sort_keys=True, separators=(",", ":")))
