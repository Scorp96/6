        ...
        prompt = json.dumps(
            {
                ...
                "response_contract": {
                    "binding_field_location": "TOP_LEVEL",
                    "required_top_level_fields": [
                        "master_decision_version",
                        "project_id",
                        "intent_id",
                        "master_epoch",
                        "base_state_version",
                ...
                "instructions": [
                    ...
                    "Copy project_id, intent_id, master_epoch, base_state_version, operator_generation, objective_generation, and input_snapshot_sha256 from reasoning_binding to the RESPONSE TOP LEVEL exactly; do not return a nested reasoning_binding object.",
                    "Include a non-empty top-level reason string for every action.",
